...
X = merged_data[['시가', '고가', '저가', '거래량', 'EPS', 'PER', 'PBR', 'BPS']]
y = merged_data['종가']
...
########################################################################################
# MSE 및 R-squared(적합도) 평가 gb
mse_gb = mean_squared_error(y_test, y_pred_gb)
r2_gb = r2_score(y_test, y_pred_gb)

# MSE 및 R-squared(적합도) 평가 lr
...
next_week_features = next_week_merged_data[['시가', '고가', '저가', '거래량', 'EPS', 'PER', 'PBR', 'BPS']]
